namespace Zoro.Network.P2P
{
    public class MessageType
    {
        ...
        public static string GetDataGroup = "getdatagroup";
        ...
        public static string RawTxnInv = "rawtxninv";
        public static string GetRawTxn = "getrawtxn";
        ...
        public static string TxnInv => ProtocolSettings.Default.EnableRawTxnList ? RawTxnInv : Inv;
    }
}
