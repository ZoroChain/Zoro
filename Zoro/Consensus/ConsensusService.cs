    ...
    public sealed class ConsensusService : UntypedActor
    {
        ...
        private bool AddTransaction(Transaction tx, bool verify)
        {
            if (context.Snapshot.ContainsTransaction(tx.Hash) ||
                ...
                !PluginManager.Instance.CheckPolicy(tx))
            {
        ...
        {            
            ...
            foreach (IPolicyPlugin plugin in PluginManager.Instance.Policies)
        ...
        {
            PluginManager.Instance.Log(nameof(ConsensusService), level, message, chainHash);
        }
